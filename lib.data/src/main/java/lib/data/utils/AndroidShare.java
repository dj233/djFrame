...
public class AndroidShare {
    ...
    private static AndroidShare _$;
    public static AndroidShare $(){
        if(_$ == null){
            synchronized (AndroidShare.class){
                _$ = new AndroidShare();
            }
        }
        return _$;
    ...
    public void shareTxtChoose(String msgTitle,String msgText){
        shareMsgChoose(msgTitle,msgText,null,AndroidShare.TEXT);
    }

    public void shareBmpChoose(String msgTitle,String msgText,Bitmap bitmap){
        shareMsgChoose(msgTitle,msgText,bitmap,AndroidShare.DRAWABLE);
    }

    public void shareMsgChoose(String msgTitle,String msgText,Bitmap drawable,int type){
        shareMsg(null,null,null,msgTitle,msgText,type,drawable);
    }
    ...
    private void shareMsg(String packageName, String activityName,
                          ...
                          Bitmap drawable) {
        if (!TextUtils.isEmpty(packageName) && !isAvilible(context, packageName)) {// 判断APP是否存在
...
//          Bitmap bt = bd.getBitmap();
     ...
     * @param bitmap
     */
    public void shareBitmapToQQ(Activity context, Bitmap bitmap){
        shareBitmap(context,bitmap,"");
    }

    public void shareBitmap(Activity context,Bitmap bitmap,String targetPkg){
        Uri uri = Uri.parse(MediaStore.Images.Media.insertImage(
                context.getContentResolver(), bitmap, null, null));
        Intent imageIntent = new Intent(Intent.ACTION_SEND);
        if(!TextUtils.isEmpty(targetPkg)){
            imageIntent.setPackage(targetPkg);
        }
